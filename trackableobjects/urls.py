...
from trackableobjects.infrastructure.mobile_views.select_trackable_object_instance import MobileViewsTrackableObjectInstanceListView
from trackableobjects.infrastructure.mobile_views.register_trackable_object_instance import TrackableObjectInstanceCreateView
from trackableobjects.infrastructure.mobile_views.update_trackable_object_instance import TrackableObjectInstanceUpdateView
...
urlpatterns = [
    ...
    path('mobile/', include(([
        ...
        path('<int:pk>/', MobileViewsTrackableObjectInstanceListView.as_view(), name='trackable_object_instance_list'),
        path('<int:pk>/create/', TrackableObjectInstanceCreateView.as_view(), name='trackable_object_create'),
        path('instance/<int:pk>/edit/', TrackableObjectInstanceUpdateView.as_view(), name='trackable_object_edit'),
